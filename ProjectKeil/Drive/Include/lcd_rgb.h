...
#define 	LCD_CLK  		29		//定义LCD驱动时钟，这里为了方便计算数值应在10-70之间，单位为M
...
#define	Mode_H	1		//LCD水平显示
#define	Mode_V	0		//LCD竖屏显示
...
//#define LCD_Width     1024				//LCD的像素长度
//#define LCD_Height    600				//LCD的像素宽度
//#define LCD_Pixels    1024*600 		//分辨率
...
#define LCD_Width     1260				//LCD的像素长度
#define LCD_Height    352				//LCD的像素宽度
